...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-24 overflow-hidden">
      ...
      <div className="absolute bottom-0 w-full h-32 bg-gradient-to-t from-primary/10 to-transparent" />

      <div className="relative z-10 max-w-5xl px-8 text-center animate-fade-up">
        <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-[10px] font-label font-bold uppercase tracking-[0.2em] mb-10">
        ...
        <p className="font-body text-xl md:text-2xl text-on-surface-variant max-w-2xl mx-auto mb-16 leading-relaxed opacity-80">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
          <Link
            href="#upload"
            className="w-full md:w-auto bg-primary text-black px-12 py-5 rounded-full font-headline font-bold text-lg button-glow hover:scale-105 active:scale-95 transition-all duration-300"
          >
            Upload Logs
          </Link>
          <Link
